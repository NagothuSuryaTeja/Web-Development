...
app.post("/submit", (req, res) => {
  ...
  var brandName = randomName(adj,noun);
  res.render("index.ejs",{name:brandName});
...
{
  var index1 = Math.round(Math.random()*adj.length);
  var index2 = Math.round(Math.random()*noun.length);
